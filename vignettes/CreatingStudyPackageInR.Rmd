...
- Install the dependencies for the skeleton (source the file at: [https://github.com/OHDSI/SkeletonPredictionStudy/blob/master/extras/packageDeps.R](https://github.com/OHDSI/SkeletonPredictionStudy/blob/master/extras/packageDeps.R) )
